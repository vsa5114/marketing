...
<body>
    ...
    <div class="container">
        <div class="history__block">
            ...
            <div class="history__box">
                ...
                <div class="history__inner__box">
                    ...
                    <?php
                        ...
                        $kuba_historyes = mysqli_query($conn, "SELECT * FROM `kube` WHERE `user_id` = '$user_id' AND `type` = 'hujalik' AND `date` BETWEEN '$mounth' AND '$now'");
            ...
            <div class="kuba__summa">
                <?php
                    ...
                    $kuba_summa_huj = mysqli_query($conn, "SELECT SUM(kuba_count) AS kube_day FROM `kube` WHERE `user_id` = '$user_id' AND `type` = 'hujalik' AND `date` BETWEEN '$mounth' AND '$now'");
            ...
            <div class="history__box">
                ...
                <div class="history__inner__box">
                    ...
                    <?php
                        ...
                        $kuba_historyes = mysqli_query($conn, "SELECT * FROM `kube` WHERE `user_id` = '$user_id' AND `type` = 'zavod' AND `date` BETWEEN '$mounth' AND '$now'");
                        $kuba_historyes = mysqli_fetch_all($kuba_historyes);
                        $kuba_historyes = array_reverse($kuba_historyes);
                        foreach($kuba_historyes as $kuba_history) {
                            $client_id = $kuba_history[2];
            ...
            <div class="kuba__summa">
                <?php
                    ...
                    $kuba_summa_zav = mysqli_query($conn, "SELECT SUM(kuba_count) AS kube_day FROM `kube` WHERE `user_id` = '$user_id' AND `type` = 'zavod' AND `date` BETWEEN '$mounth' AND '$now'");
        ...
        <div class="all__kubas">
            <?php
                $all_kuba = $kuba_summa_huj + $kuba_summa_zav;
                echo $all_kuba;
            ?>
        </div>
