    ...
    <div class="container">
        <div class="manager__grid">
                ...
                <div class="clients__box">
                    ...
                    <div class="info__intro">
                        <?php
                            ...
                            $clients = mysqli_query($conn, "SELECT * FROM `clients` WHERE `status` = 'aloqaga chiqilmagan'");
            ...
            <div class="clients" id="box2">
                ...
                <div class="clients__box">
                    ...
                    <div class="info__intro">
                        ...
                        $clients = mysqli_query($conn, "SELECT * FROM `clients` WHERE `status` = 'kutilmoqda'");
                        $clients = mysqli_fetch_all($clients);
                ...
                <div class="clients__box">
                    ...
                    <div class="info__intro">
                        <?php
                            ...
                            $clients = mysqli_query($conn, "SELECT * FROM `clients` WHERE `status` = 'aloqada'");
                            $clients = mysqli_fetch_all($clients);
            ...
            <div class="clients" id="box4">
                <h2 class="clients__title mini">biktirilgam mijozlar</h2>
