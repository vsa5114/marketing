...
<body>
    ...
    <div class="container">
        <div class="history__block">
            <h2 class="kuba__title">davr ichida sotilgan kubalar tarixi</h2>
            ...
            <div class="history__box">
                ...
                <div class="history__inner__box">
                    ...
                    <?php
                        ...
                        $kuba_historyes = mysqli_query($conn, "SELECT * FROM `kube` WHERE `user_id` = '$user_id' AND `date` BETWEEN '$start' AND '$end'");
            ...
            <div class="kuba__summa">
                <?php
                    ...
                    $kuba_summa_zav = mysqli_query($conn, "SELECT SUM(kuba_count) AS kube_day FROM `kube` WHERE `user_id` = '$user_id' AND `date` BETWEEN '$start' AND '$end'");
